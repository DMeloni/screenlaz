 ...
 * Préfixe de Atom dans les requêtes XPATH
*/
define('XPATH_PREFIX_MEDIA', 'media');
/**
 * Namespace Atom
*/
define('XPATH_NAMESPACE_MEDIA', 'http://search.yahoo.com/mrss/');

/**
 * Préfixe de Atom dans les requêtes XPATH
*/
define('XPATH_PREFIX_GD', 'gd');
/**
 * Namespace Atom
*/
define('XPATH_NAMESPACE_GD', 'http://schemas.google.com/g/2005');

/**
 * Préfixe de Atom dans les requêtes XPATH
*/
define('XPATH_PREFIX_YT', 'yt');
/**
 * Namespace Atom
*/
define('XPATH_NAMESPACE_YT', 'http://gdata.youtube.com/schemas/2007');
...
define('XPATH_FEED_ENTRY', '/feed/entry');
...
function registerDefaultXPathNamespaces(SimpleXMLElement $xml) {
    ...
    $xml->registerXPathNamespace(XPATH_PREFIX_YT, XPATH_NAMESPACE_YT);
    $xml->registerXPathNamespace(XPATH_PREFIX_GD, XPATH_NAMESPACE_GD);
    $xml->registerXPathNamespace(XPATH_PREFIX_MEDIA, XPATH_NAMESPACE_MEDIA);
}
